...
OUT = '/opt/scrapbot-blender-quality/v2'
...
GALV = material('GalvanizedSteel', (0.34, 0.38, 0.40), 0.82, 0.40)
CHAR = material('CharcoalSteel', (0.035, 0.045, 0.055), 0.82, 0.32)
YELLOW = material('IndustrialYellow', (0.92, 0.43, 0.018), 0.67, 0.39)
CUTTER = material('HardenedCutterSteel', (0.07, 0.075, 0.082), 0.93, 0.20)
BLUE = material('MotorBlue', (0.035, 0.12, 0.22), 0.62, 0.34)
...
# Save + export
# -----------------------------------------------------------------------------
blend_path = os.path.join(OUT, 'industrial_scrap_shredder_v2.blend')
glb_path = os.path.join(OUT, 'industrial_scrap_shredder_v2_roblox.glb')
