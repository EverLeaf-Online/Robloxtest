...
>
> **Current launch gate — 2026-09-20:** use `docs/ROADMAP.md` for current Beta/Public Beta status and remaining live/manual blockers. Dated validation snapshots are archived under `docs/archive/status/` as historical evidence.
