...
local WorldLayout = {
	Plot = {
		...
		EntryOffset = Vector3.new(-86, 1, -47),
	...
	Production = {
		...
		IndexTerminalOffset = Vector3.new(-38, 2.8, -40),
		BotConsoleOffset = Vector3.new(-25, 2.8, -40),
		UpgradeConsoleOffset = Vector3.new(-12, 2.8, -40),
		WorkPadOriginOffset = Vector3.new(76, 0.75, -20),
	...
	Environment = {
		...
		WorkerBayCenterOffset = Vector3.new(81.5, 0, -10),
		MainAisleCenterOffset = Vector3.new(0, 0, -16),
	},
